    ...
    def select_best_path_index(self, paths, collision_check_array, goal_state):
        ...
        for i in range(len(paths)):
            ...
            if collision_check_array[i]:
                ...
                # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
                # --------------------------------------------------------------
                center_dist_delta_vector = [paths[i][0] - goal_state[0],
                                            paths[i][1] - goal_state[1]]
                center_distance = np.linalg.norm(center_dist_delta_vector)
                ...
                for j in range(len(paths)):
                    if j == i:
                        ...
                        if not collision_check_array[j]:
                            # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
                            col_path_dist_delta_vector = [paths[i][0] - paths[j][0],
                                                          paths[i][1] - paths[j][1]]
                            col_path_distance = np.linalg.norm(
                                col_path_dist_delta_vector)
                            # --------------------------------------------------
                            score += self._weight * col_path_distance
                            # --------------------------------------------------
