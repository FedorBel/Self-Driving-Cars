...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
        # ------------------------------------------------------------------
        turn_theta = -ego_state[2]
        goal_x = goal_state_local[0] * cos(turn_theta) - \
            goal_state_local[1] * sin(turn_theta)
        goal_y = goal_state_local[0] * sin(turn_theta) + \
            goal_state_local[1] * cos(turn_theta)
        # ------------------------------------------------------------------
